...
2. 实验设计与推断中：如何定量描述“应用场景属性—实验设计与算法结构—统计效率”之间的性能极限，并基于此开发具有最优（或近最优）性质的设计与推断框架[(J2, C3, C4, C9, C10, C12, P1)](https://zhzhang01.github.io/publications/)？

3. 离线/在线学习与决策中：如何从数学结构上统一机器学习、经济管理与统计推断等不同领域的优化目标，揭示它们之间的基本兼容性与最优可达边界[(C5, C9, C10, C11, C15, P2, P3)](https://zhzhang01.github.io/publications/)？
   

**为回答上述问题，实验室的总体研究路线遵循由理论到方法、由方法到实践的逐层递进结构：**

1. 从基础假设的违背出发，构建更具包容性的因果推断框架，例如：探索 unconfoundedness、overlap、SUTVA 等假设的违背情形[(J1, J2, J3, C3, C5, C13, C14)](https://zhzhang01.github.io/publications/)；

2. 将这些基础结构与现代统计与机器学习方法融合，发展更高效、更稳定、更具可扩展性的识别与估计技术，例如：最优传输、代理变量与负控方法、共型预测、minimax优化、在线学习等；[(J1, J3, C1, C2, C4, C6, C8, C12, C13, C14, P1)](https://zhzhang01.github.io/publications/)；

3. 进一步将理论与方法扩展至带有现实约束的任务设置，例如：输入/输出复杂结构、小样本学习、动态/缺失网络结构等[(C1, C2, C3, C4, C6, C8, C11, C12, P2, P3)](https://zhzhang01.github.io/publications/)；

4. 最终形成能向现实场景有效辐射的因果推断体系，服务于社交网络分析、博弈论环境、优化决策，并落地于推荐系统、派单机制、市场干预策略、大模型行为建模等[(C7, C9, C10, C11, C15, P2, P3, P5)](https://zhzhang01.github.io/publications/)；
其中：1 关注输入层面更宽松的结构假设，2 聚焦算法层面精准且高效的识别—估计机制，3-4 主要面向输出层面复杂而贴近现实的决策与推断任务。


**为逐步实现，目前实验室正主要围绕以下三个具体方向做研究：**

1. 网络结构下的在线实验设计与推断[(J2, C5, C9, C10, C11, C12, P3)](https://zhzhang01.github.io/publications/)；

2. 因果推断中的最优传输（OT）与几何结构[(J1, C6, C13, C14)](https://zhzhang01.github.io/publications/)；

3. 面向工业现实约束的因果推断方法论（如RCT&OBS, pre&opt, structural data types）[(C1, C2, C3, C4, C7, C8, C15, P2, P3)](https://zhzhang01.github.io/publications/)。
...
Zhiheng Zhang (pronunciation: Zhee-hung Jahng) is a tenure-track Assistant Professor in the [School of Statistics and Data Science](https://ssm.sufe.edu.cn/) at the [Shanghai University of Finance and Economics](https://www.sufe.edu.cn/), starting from 2025.08. Previously, he received his Ph.D. from the [Institute for Interdisciplinary Information Sciences](https://iiis.tsinghua.edu.cn/), Tsinghua University, advised by Professor [Yuhao Wang](https://yuhaow.github.io/). Zhiheng Zhang is the co-Principal Investigator of the 2025 [CCF-DiDi Gaia Collaborative Research Fund project](https://outreach.didichuxing.com/app-outreach/CRFYS) titled "Unified multi treatment LTV causal model" and the area chair of AAAI2025 AICT track. He is looking for [PhD/Master/Interns](https://mp.weixin.qq.com/s/XkFc2gSXFDegj9HVEHGPaQ). His email is zhangzhiheng@mail.shufe.edu.cn.
