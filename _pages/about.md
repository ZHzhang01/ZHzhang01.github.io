...
1）对于基于观测性研究的因果推断，如何描述“场景假设-数学结构-识别边界”之间的关系？
2）对于离线实验设计，如何描述“场景假设-估计器结构-估计效率”之间的关系？
3）对于在线实验设计，如何描述
...
Recruitment for Ph.D. Students/Master students/Interns
======
我正在寻找若干将于 **2025 年入学的硕士生**，以及 **2026 年入学的博士/硕士生**。同时也长期招收科研实习生（支持远程线上实习）。

我对博士生的基本期望包括：

1. 具备明确的内驱力（鼓励自主探索感兴趣的研究方向）；
2. 满足以下两项中的**任意一项**：
   - 拥有扎实的数学基础，尤其是在概率论与数理统计方面（不限于数学相关专业）；
   - 拥有出色的编程能力。
