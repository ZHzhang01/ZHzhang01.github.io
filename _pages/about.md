...
<div style="border: 1.5px solid #e5e7eb; padding: 20px; margin: 20px 0; border-radius: 10px; background-color: #f9fafb; box-shadow: 2px 2px 6px rgba(0,0,0,0.05); line-height: 1.8;">
  ...
  <ul style="margin: 8px 0 16px 24px; padding-left: 20px;">
    <li>具备良好的品德和沟通能力，内驱力强，作风扎实。喜欢科研探索（鼓励自主探索感兴趣的方向。我会在能力范围内尽力指导；在能力范围外建立合作）；</li>
  ...
  <ul style="margin: 8px 0 16px 24px; padding-left: 20px;">
    <li>具备良好的品德和沟通能力，作风扎实；</li>
    <li>对于有志于学界的，我会跟博士生共同带领你进行科研，并支持你的继续深造；对于有志于业界的，我希望你主动求职的是<strong>算法科研</strong>岗位，我会根据适配度将你推荐到相关方向的前沿研究部门实习。此外，至少在在读期间与我完成一个你自己的科研课题，作为你的毕业论文。</li>
  </ul>
...
4. 未来拓展方面，实验室将以现实干预和智能决策中的组合空间爆炸为切入点，推进从复杂实验设计到可信 AI 决策、再到可识别科学发现的统一研究。面对高维 treatment、网络暴露、组合行动空间和复杂行为轨迹，单个实验已难以充分刻画干预机制；因此，我们将借助大模型语义表征与生成式方法，把分散的实验对象、实验结果和上下文条件组织成可计算、可比较、可桥接的因果结构。在此基础上，我们将进一步研究战略环境中的可信 AI 决策理论：即如何在多智能体互动、平台机制、市场干预与大模型行为系统中设计规则、干预和采样策略，使复杂系统不仅具有较好的短期表现，而且能够在长期演化中保持可解释、可评估和可控。进一步地，这一结构也可以用于系统梳理既有社会实验之间的链接、冲突与空白：当多个实验能够在 treatment–outcome–context–effect 空间中相互组合时，我们研究这种组合何时具有因果意义；当组合失败或结论冲突时，我们研究何时只能给出部分识别边界，以及如何主动设计新的 bridge experiments 来缩小不可识别区域。由此，未来研究将从“如何设计复杂实验”进一步推进到“如何组织实验空间、构建可信决策机制、识别机制边界，并通过最优实验设计推动不可识别问题尽可能走向可识别”，最终形成面向科学发现的可识别学习理论。

![ATLAS计划](ATLAS_final.png)
