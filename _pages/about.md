...
Welcome to Zhiheng's Lab! This lab is called **CAUSAL** (**C**ausal **A**nalysis for **U**nderlying **S**tructures **A**nd **L**earning), focusing on developing principled methods for causal analysis by uncovering underlying structures and integrating them with modern learning and decision-making systems. Please read [the onboarding guide of CAUSAL lab](./CAUSAL_Lab_Onboarding_Guide.pdf).

欢迎访问张智恒的主页！本实验室名为**CAUSAL** (**C**ausal **A**nalysis for **U**nderlying **S**tructures **A**nd **L**earning)，致力于发展有理论基础和落地应用的因果推断方法，聚焦于潜在结构的刻画，并将其与现代学习算法和决策系统融合。[请查看实验室因果推断入门指南](./CAUSAL_Lab_Onboarding_Guide.pdf)。
