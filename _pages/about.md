...
他的[代表性研究成果](https://scholar.google.com/citations?hl=zh-CN&user=YVXrszoAAAAJ&view_op=list_works&sortby=pubdate)工作构建了一个*“识别-估计-策略优化”*的闭环范式，寻求*“假设 → 结构 → 推断目标”* 的统一建模路径，致力于推动因果学习理论与应用的深度结合。
